...
// 명시적으로 표시함
@Repository
public interface BonRepository extends CrudRepository<Bon1, LocalDateTime> {
...
//	List<Bon1> findByDateBetween(LocalDateTime startDate, LocalDateTime endDate);
	...
	List<Bon1> findByDateBetweenAndJeosujiEquals(LocalDateTime startDate, LocalDateTime endDate, char jeosuji);
