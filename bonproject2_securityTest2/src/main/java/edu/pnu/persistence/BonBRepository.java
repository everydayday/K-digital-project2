...
// 명시적으로 표시함
@Repository
public interface BonBRepository extends CrudRepository<BonB, LocalDateTime> {
...
//	List<BonA> findBonAByDateBetweenAndJeosujiEquals(LocalDateTime startDate, LocalDateTime endDate, char jeosuji);
	...
	List<BonB> findBonBByDateBetween(LocalDateTime startDate, LocalDateTime endDate);
